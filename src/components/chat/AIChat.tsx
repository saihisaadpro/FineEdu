    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-blue-600 text-white rounded-full px-5 py-3 shadow-lg hover:bg-blue-700 transition-all hover:shadow-xl active:scale-95"
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-6 right-6 z-50 w-[360px] max-h-[520px] bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col animate-in slide-in-from-bottom-4 duration-200">
          {/* Header */}
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 min-h-[240px] max-h-[360px]">
            {messages.length === 0 && (
